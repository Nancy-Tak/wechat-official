...
class GetCode extends React.Component {
    ...
    submit = ()=> {
        this.props.form.validateFields((errors, value) => {
            ...
            //agencyId	所属机构	string
            //connector	联系人姓名	string
            //connectorIdCard	身份证号码	string
            //connectorType	联系人类型	number
            //id	商户ID	string	修改时传递过来
            //phone	手机号码	string
            //procecssCode	流程编码	string
            //verifyCode
            axios
                .post(`/api/register/save/contactor`, {
                    verifyCode: code,
                    connector: formData.users,
                    connectorIdCard: formData.IdCard,
                    phone: formData.mobile,
                    connectorType: formData.connectType[0],
                    agencyId: formData.bank[0],
    ...
    render() {
        ...
        return (
            <div className='step-wrap'>
                <div>
                    短信验证码将发送至您的手机，请耐心等待。1分钟后可重新获取验证码。
                </div>
