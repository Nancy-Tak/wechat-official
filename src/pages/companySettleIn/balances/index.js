...
class Balances extends React.Component {
    ...
    //上一步
    handleBackClick = () => {
        this.props.router.push(`/enterpriseBasicInfo`)
    };
    onChange = (val) => {
        console.log(val);
    }
    ...
    nextStepClick = ( ) => {
        ...
        this.props.form.validateFields((errors, value) => {
            if (errors) {
                ...
                console.log('value是：',value,this.state.bankId, 'bankId',this.state.bankName ,'bankName')
             // console.log(value,"表单无误")
            //     console.log('bankId',value.bankName[0])
            //     console.log(this.state.bankName,'bankName')
                ...
                axios
                    ...
                    .then(res=>{
                        ...
                        this.props.router.push(`/resultPage?status=${res.status}&message=${res.message}`)
                    })
                    .catch(error=>{
                        Toast.fail(`${error.message}`, 3);
                    })
    ...
    render() {
        ...
        const fieldProps = {
            ...
            bankProvinceName: {
                ...
                // intialValue:this.state.bValue1 ? [this.state.bValue1] : [],
                rules: [
                    {
                        required: true,
                        message: '所属省不能为空'
...
export default createForm()(Balances);
